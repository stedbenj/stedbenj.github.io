...
import sty from "./PlasmicButton2.module.css"; // plasmic-import: WYZ_00FUz_-/css

import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: kxfh07Imu5R/icon
import Icon38Icon from "./icons/PlasmicIcon__Icon38"; // plasmic-import: 02U_6EeSozy/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__tDT)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg___4O1Y5)}
                role={"img"}
              />
            ),
